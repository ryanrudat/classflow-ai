...
-- Add pushed_at column to activities table
ALTER TABLE activities
ADD COLUMN pushed_at TIMESTAMP DEFAULT NULL;
...
CREATE INDEX idx_activities_pushed_at ON activities(pushed_at) WHERE pushed_at IS NOT NULL;
